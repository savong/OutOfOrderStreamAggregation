                ...
                if((current_time-Long.parseLong(cells[0]))/10000<=max_lateness)
                {
                    ...
                    if(duration < (round+1)*f1)
                    {
                        if(pvalue_perslide.containsKey(index_falling))
                        {
                            ...
                            co_ag_pair.aggregation = co_ag_pair.aggregation + Double.valueOf(cells[1]);
                            co_ag_pair.aggregation_square = co_ag_pair.aggregation_square + Double.valueOf(cells[1])*Double.valueOf(cells[1]);
                        ...
                        else
                        {
                            ...
                            co_ag_pair.count = 1;
                            co_ag_pair.aggregation = Double.valueOf(cells[1]);
                            co_ag_pair.aggregation_square = Double.valueOf(cells[1])*Double.valueOf(cells[1]);
                            pvalue_perslide.put(index_falling, co_ag_pair);
                        }
