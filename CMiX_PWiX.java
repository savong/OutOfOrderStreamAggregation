        ...
        int range = 8; // window size
                ...
                int round=0;
                   ...
                   Map<Integer, Double> pvalue_perslide = new HashMap<Integer, Double>();
                    ...
                    double[] cvalue_s = new double[n_checkpoints];
                    double[] pvalue_s = new double[num_slide];
                    Map<Integer, Double> pvalue_perslide_s = new HashMap<Integer, Double>();
                    double g_value_s=0;
                    Node Tree_s = BST(checkpoint_size+rmd_tmp);
                   ...
                   public Integer fold(Integer acc, Tuple2<String, Integer> value) throws Exception{
                       ...
                       //if(count<=f1)
                            ...
                            for(int k=0;k<num_slide;k++)
                            {
                                ...
                                if(inRange(slide*k, slide*(k+1), (Integer.parseInt(value.f0)/1000)%(range))) //second
                                {
                                    ...
                                    if(pvalue_perslide.containsKey(k))
                                        ...
                                        pvalue_perslide_s.put(k, pvalue_perslide.get(k) + value.f1*value.f1);
                                    else
                                        pvalue_perslide.put(k, (double)value.f1);
                                        pvalue_perslide_s.put(k, (double)value.f1*value.f1);
                                    break;
                                }
                            }
                        }
                        ...
                        if(Integer.parseInt(value.f0)/1000 >= currTimes_lastslide + slide)
                        {
                            ...
                            for (Map.Entry<Integer, Double> entry : pvalue_perslide_s.entrySet())
                            {
                                //if late arrival records fall onto the respecitve pvalue and cvalue.
                                int low_bound = 0;
                                for(int j=0;j<n_checkpoints;j++)
                                {
                                    if(inRange(low_bound, checkpoint_size*(j+1)+rmd, entry.getKey()))
                                    {
                                        cvalue_s[j]+=entry.getValue();
                                        break;
                                    }
                                    low_bound = checkpoint_size*(j+1)+rmd;
                                }
                                pvalue_s[entry.getKey()] = entry.getValue();
                                g_value_s += entry.getValue();
                                //if late arrival records fall onto the tree
                                //insert(Tree, entry.getKey()+1, entry.getValue(), 1);
                            }

                            pvalue_perslide.clear();
                            pvalue_perslide_s.clear();
                        //    cvalue[chkp_round]+=f1_value;
                        //    pvalue[round] = f1_value;
                            insert(Tree, chkp_count, 0, 1);
                            insert(Tree_s, chkp_count, 0, 1);
                            double results_s=0.0;
                            if(chkp_count < checkpoint_size+rmd_tmp)
                            {
                                results = g_value+Tree.aggregating;
                                results_s = g_value_s+Tree_s.aggregating;
                            }
                            else
                            {
                                results = g_value;
                            ...
                            //if(Integer.parseInt(value.f0)/1000 >= currTimes_lastchpoint + checkpoint_size + rmd_tmp)
                            {
                                ...
                                if(full_window==true || round==num_slide-1)
                                {
                                   Tree = BST(checkpoint_size+rmd_tmp);
                                    Tree_s = BST(checkpoint_size+rmd_tmp);
                                   ...
                                   for(int k=0;k<checkpoint_size+rmd_tmp;k++)
                                   {
                                       ...
                                       insert(Tree_s, k+1, pvalue_s[k+tmp_curptr], 1);
                                   }
                                   //insert(Tree, 2, 0, 1);
                                   g_value=0;
                                   cvalue[chkp_round]=0;
                                    g_value_s=0;
                                    cvalue_s[chkp_round]=0;
                                   for(int k=0;k<n_checkpoints;k++)
                                   {
                                       g_value += cvalue[k];
                                       g_value_s += cvalue_s[k];
                                   }
                                }
                            ...
                            acc = results_s-2*results*(results/count)+(results/count)^2;
                ...
                .fold(new Integer (0), new FoldFunction<Tuple2<String, Integer>, Integer>() {
                   ...
                   Map<Integer, Double> pvalue_perslide2 = new HashMap<Integer, Double>();
                    ...
                    double[] cvalue_s = new double[n_checkpoints];
                    double[] pvalue_s = new double[num_slide];
                    Map<Integer, Double> pvalue_perslide1_s = new HashMap<Integer, Double>();
                    Map<Integer, Double> pvalue_perslide2_s = new HashMap<Integer, Double>();
                    double g_value_s=0;
                   ...
                   public Integer fold(Integer acc, Tuple2<String, Integer> value) throws Exception{
                       ...
                       count++;
                        ...
                        if(Integer.parseInt(value.f0)/1000 <= currTimes_lastslide + f1)
                        {
                            for(int k=0;k<num_slide;k++)
                            {
                                ...
                                if(inRange(slide*k, slide*(k+1), (Integer.parseInt(value.f0)/1000)%(range+1))) //second
                                {
                                    ...
                                    {
                                        pvalue_perslide1.put(k, pvalue_perslide1.get(k) + value.f1*value.f1);
                                        pvalue_perslide1_s.put(k, pvalue_perslide1_s.get(k) + value.f1*value.f1);
                                    }
                                    else
                                    {
                                        pvalue_perslide1.put(k, (double)value.f1);
                                        pvalue_perslide1_s.put(k, (double)value.f1*value.f1);
                                    }
                            ...
                            for(int k=0;k<num_slide;k++)
                            {
                                ...
                                if(inRange(slide*k, slide*(k+1), (Integer.parseInt(value.f0)/1000)%(range+1))) //second
                                {
                                    if(pvalue_perslide2.containsKey(k))
                                    {
                                        ...
                                        pvalue_perslide2_s.put(k, pvalue_perslide2_s.get(k) + value.f1*value.f1);
                                    }
                                    else
                                    {
                                        pvalue_perslide2.put(k, (double)value.f1);
                                        pvalue_perslide2_s.put(k, (double)value.f1*value.f1);
                                    }
                                    break;
                                }
                            }
                        ...
                        if(Integer.parseInt(value.f0)/1000 >= currTimes_lastslide + slide)
                        {
                            ...
                            for (Map.Entry<Integer, Double> entry : pvalue_perslide1_s.entrySet())
                            {
                                //if late arrival records fall onto the respecitve pvalue and cvalue.
                                int low_bound = 0;
                                for(int j=0;j<n_checkpoints;j++)
                            ...
                            for (Map.Entry<Integer, Double> entry : pvalue_perslide2_s.entrySet())
                            {
                                //if late arrival records fall onto the respecitve pvalue and cvalue.
                                int low_bound = 0;
                                int part_tmp;
                                ...
                                for(int j=0;j<n_checkpoints;j++)
                                {
                                    if(inRange(low_bound, checkpoint_size*(j+1)+rmd, part_tmp))
                                    {
                                        cvalue_c[j]+=entry.getValue();
                                        break;
                                    }
                                    low_bound = checkpoint_size*(j+1)+rmd;
                                }
                                pvalue_s[part_tmp] = entry.getValue();
                                g_value_s += entry.getValue();
                            }
                            pvalue_perslide2.clear();
                            pvalue_perslide2_s.clear();
                            double results=0.0;
                            double results_s=0.0;
                            insert(Tree, chkp_count, 0, 1);
                            insert(Tree_s, chkp_count, 0, 1);
        ...
        int range = 8; // window size
                ...
                .fold(new Integer (0), new FoldFunction<Tuple2<String, Integer>, Integer>() {
                   ...
                   Map<Integer, Double> pvalue_perslide = new HashMap<Integer, Double>();
                    ...
                    double g_value_max=0;
                    Node Tree_max = BST(checkpoint_size+rmd_tmp);
                    double[] cvalue_max = new double[n_checkpoints];
                    double[] pvalue_max = new double[num_slide];
                    Map<Integer, Double> pvalue_perslide_max = new HashMap<Integer, Double>();
                   ...
                   public Integer fold(Integer acc, Tuple2<String, Integer> value) throws Exception{
                            ...
                            for(int k=0;k<num_slide;k++)
                            {
                                ...
                                if(inRange(slide*k, slide*(k+1), (Integer.parseInt(value.f0)/1000)%(range))) //second
                                {
                                    ...
                                    if(pvalue_perslide.containsKey(k))
                                        {
                                            pvalue_perslide.put(k, Math.min(pvalue_perslide.get(k), value.f1));
                                            pvalue_perslide_max.put(k, Math.max(pvalue_perslide.get(k), value.f1));
                                        }
                                    else
                                        {
                                            pvalue_perslide.put(k, (double)value.f1);
                                            pvalue_perslide_max.put(k, (double)value.f1);
                                        }
                                    break;
                                }
                            }
                        ...
                        if(Integer.parseInt(value.f0)/1000 >= currTimes_lastslide + slide)
                        {
                            ...
                            for (Map.Entry<Integer, Double> entry : pvalue_perslide_max.entrySet())
                            {
                                //if late arrival records fall onto the respecitve pvalue and cvalue.
                                int low_bound = 0;
                                for(int j=0;j<n_checkpoints;j++)
                                {
                                    ...
                                    {
                                        //cvalue[j]+=entry.getValue();
                                        cvalue_max[j] = Math.max(cvalue_max[j], entry.getValue());
                                        break;
                                    }
                                    low_bound = checkpoint_size*(j+1)+rmd;
                                }
                                pvalue_max[entry.getKey()] = entry.getValue();
                                //g_value += entry.getValue();
                                g_value_max = Math.max(g_value_max, entry.getValue());
                                //if late arrival records fall onto the tree
                                //insert(Tree, entry.getKey()+1, entry.getValue(), 1);
                            }
                            pvalue_perslide.clear();
                            pvalue_perslide_max.clear();
                        //    cvalue[chkp_round]+=f1_value;
                        //    pvalue[round] = f1_value;
                            insert(Tree, chkp_count, 0, 1);
                            insert(Tree_max, chkp_count, 0, 1);
                            double results=0.0;
                            if(chkp_count < checkpoint_size+rmd_tmp)
                                {
                                    //results = g_value+Tree.aggregating;
                                    results = Math.min(g_value, Tree.aggregating);
                                    results_max = Math.max(g_value_max, Tree_max.aggregating);
                                }
                            else
                                {
                                    results = g_value;
                                    results_max = g_value_max;
                                }
                            ...
                            //if(Integer.parseInt(value.f0)/1000 >= currTimes_lastchpoint + checkpoint_size + rmd_tmp)
                            {
                                ...
                                if(full_window==true || round==num_slide-1)
                                {
                                   ...
                                   for(int k=0;k<checkpoint_size+rmd_tmp;k++)
                                   {
                                       //pvalue[k+tmp_curptr] += pvalue[k+1+tmp_curptr];
                                       insert(Tree, k+1, pvalue[k+tmp_curptr], 1);
                                       insert(Tree_max, k+1, pvalue_max[k+tmp_curptr], 1);
                                   }
                                   //insert(Tree, 2, 0, 1);
                                   g_value=0;
                                   cvalue[chkp_round]=0;
                                    g_value_max=0;
                                    cvalue_max[chkp_round]=0;
                                   for(int k=0;k<n_checkpoints;k++)
                                   {
                                       //g_value += cvalue[k];
                                       g_value = Math.min(g_value, cvalue[k]);
                                       g_value_max = Math.max(g_value_max, cvalue_max[k]);
                                   }
                                }
                                currTimes_lastchpoint = currTimestamp;
                            }
                ...
                .fold(new Integer (0), new FoldFunction<Tuple2<String, Integer>, Integer>() {
                   ...
                   Map<Integer, Double> pvalue_perslide2 = new HashMap<Integer, Double>();
                    ...
                    double[] cvalue_max = new double[n_checkpoints];
                    double[] pvalue_max = new double[num_slide];
                    Map<Integer, Double> pvalue_perslide1_max = new HashMap<Integer, Double>();
                    Map<Integer, Double> pvalue_perslide2_max = new HashMap<Integer, Double>();
                   ...
                   public Integer fold(Integer acc, Tuple2<String, Integer> value) throws Exception{
                            ...
                            for(int k=0;k<num_slide;k++)
                            {
                                ...
                                if(inRange(slide*k, slide*(k+1), (Integer.parseInt(value.f0)/1000)%(range+1))) //second
                                {
                                    ...
                                    if(pvalue_perslide1.containsKey(k))
                                        {
                                            pvalue_perslide1.put(k, Math.min(pvalue_perslide1.get(k), value.f1));
                                            pvalue_perslide1_max.put(k, Math.max(pvalue_perslide1_max.get(k), value.f1));

                                        }
                                    else
                                        {
                                            pvalue_perslide1.put(k, (double)value.f1);
                                            pvalue_perslide1_max.put(k, (double)value.f1);
                            ...
                            for(int k=0;k<num_slide;k++)
                            {
                                ...
                                if(inRange(slide*k, slide*(k+1), (Integer.parseInt(value.f0)/1000)%(range+1))) //second
                                {
                                    if(pvalue_perslide2.containsKey(k))
                                        {
                                            pvalue_perslide2.put(k, Math.min(pvalue_perslide2.get(k), value.f1));
                                            pvalue_perslide2_max.put(k, Math.max(pvalue_perslide2_max.get(k), value.f1));
                                        }
                                    else
                                        {
                                            pvalue_perslide2.put(k, (double)value.f1);
                                            pvalue_perslide2_max.put(k, (double)value.f1);
                                        }
                                    break;
                                }
                            }
                        ...
                        if(Integer.parseInt(value.f0)/1000 >= currTimes_lastslide + slide)
                        {
                            ...
                            for (Map.Entry<Integer, Double> entry : pvalue_perslide1_max.entrySet())
                            {
                                //if late arrival records fall onto the respecitve pvalue and cvalue.
                                int low_bound = 0;
                                for(int j=0;j<n_checkpoints;j++)
                                ...
                                //pvalue[entry.getKey()] += entry.getValue();
                                pvalue_max[entry.getKey()] = Math.max(pvalue_max[entry.getKey()], entry.getValue());
                                //g_value += entry.getValue();
                                g_value_max = Math.max(g_value_max, entry.getValue());
                                //if late arrival records fall onto the tree
                                //insert(Tree, entry.getKey()+1, entry.getValue(), 1);
                            }
                            pvalue_perslide1_max.clear();
                            ...
                            for (Map.Entry<Integer, Double> entry : pvalue_perslide2_max.entrySet())
                            {
                                //if late arrival records fall onto the respecitve pvalue and cvalue.
                                int low_bound = 0;
                                int part_tmp;
                                ...
                                pvalue_max[part_tmp] = entry.getValue();
                                //g_value += entry.getValue();
                                g_value_max = Math.max(g_value_max, entry.getValue());
                            }
                            pvalue_perslide2_max.clear();
